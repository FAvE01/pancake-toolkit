...
var PrivacyLinks = function (_a) {
    ...
    return (React__default['default'].createElement(Flex, __assign({}, props), privacyLinks.map(function (privacyLinkItem, index) {
        ...
        if (privacyLinkItem.href) {
            return (React__default['default'].createElement(Link, { external: true, color: "#9590A3", fontWeight: "normal", key: privacyLinkItem.label, href: privacyLinkItem.href, "aria-label": privacyLinkItem.label, mr: mr }, privacyLinkItem.label));
        }
        return (React__default['default'].createElement(Flex, { mr: mr, justifyContent: "center", alignItems: "center", style: { color: "#9590A3" } }, privacyLinkItem.label));
    })));
};
...
var FooterMenuLinks = function (_a) {
    ...
    return (React__default['default'].createElement(Flex, __assign({}, props), props.links.map(function (linkItem, index) {
        ...
        if (linkItem.href) {
            return (React__default['default'].createElement(Link, { external: true, color: "#9590A3", fontWeight: "normal", key: linkItem.label, href: linkItem.href, "aria-label": linkItem.label, mr: mr }, linkItem.label));
        }
        return (React__default['default'].createElement(Flex, { mr: mr, justifyContent: "center", alignItems: "center", style: { color: "#9590A3" } }, linkItem.label));
    })));
};
